...
Gem::Specification.new do |spec|
  ...
  spec.add_development_dependency 'oauth2', '~> 1.2', '>= 1.2.0'
  spec.add_development_dependency 'omniauth', '~> 1.3', '>= 1.3.1'
  spec.add_development_dependency 'omniauth-oauth2', '~> 1.4', '>= 1.4.0'
end
